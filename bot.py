...
# Gold prices are in the thousands (e.g. 2350.42), so 2 decimals is plenty.
DECIMALS = 2
...
send(
    "XAU/USD Bot Started! Now tracking Gold (XAU/USD). Building data, wait 2 minutes for first signals.\n\n"
    "Commands: /status, /price"
)
print("Bot started - XAU/USD only, interactive mode", flush=True)
counter = 0
